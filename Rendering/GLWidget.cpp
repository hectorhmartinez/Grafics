...
void GLWidget::initializeGL() {
    ...
    auto l1 = make_shared<PointLight>((0.2,0.2,0.2), (0.8,0.8,0.8),(1.0,1.0,1.0),(10,10,20,0.0f), (0.0,1.0f,1.0f));
    //auto l2 = make_shared<PointLight>((0.3f,0.3f,0.3f), (0.2f,0.2f,0.2f),(0.5f,0.5f,0.5f),(0.2f,0.2f,0.2f,1.0f), (0.0,1.0f,1.0f));
    //auto l3 = make_shared<PointLight>((0.3f,0.3f,0.3f), (0.5f,0.5f,0.5f),(0.5f,0.5f,0.5f),(0.5f,0.5f,0.5f,1.0f), (0.0,1.0f,1.0f));
    //auto l4 = make_shared<DirectionalLight>((0.3f,0.3f,0.3f), (0.5f,0.5f,0.5f),(0.5f,0.5f,0.5f),(0.5f,0.5f,0.5f,1.0f), (0.0,1.0f,1.0f));
    //auto l5 = make_shared<SpotLight>((0.3f,0.3f,0.3f), (0.5f,0.5f,0.5f),(0.5f,0.5f,0.5f),(0.5f,0.5f,0.5f,1.0f), (0.0,1.0f,1.0f),(0.0,1.0f,1.0f),2.5f);
    scene->addLight(l1);
    //scene->addLight(l2);
    //scene->addLight(l3);
...
void GLWidget::initShadersGPU(){
    ...
    initShader("://resources/vshaderDepth.glsl", "://resources/fshaderDepth.glsl");
    ...
    initShader("://resources/vshaderTexture.glsl", "://resources/fshaderTexture.glsl");
...
void GLWidget::initShader(const char* vShaderFile, const char* fShaderFile){
    ...
    program->link();
    program->bind();
    listOfPrograms.push_back(program);
}
...
void GLWidget::activaTexturaShader() {
    //A implementar a la fase 1 de la practica 2
    program = listOfPrograms.at(4);
    program->link();
    program->bind();
    scene->toGPU(program);
    updateGL();
    qDebug()<<"Estic a Textura";


}
void GLWidget::activaPhongTex() {
    //A implementar a la fase 1 de la practica 2
    /*program = listOfPrograms.at(5);
    program->link();
    program->bind();
    scene->toGPU(program);
    updateGL();*/
