...
shared_ptr<Material> MaterialFactory::createMaterial(vec3 a, vec3 d, vec3 s, vec3 kt,float beta, float opacity, MATERIAL_TYPES t) {
    shared_ptr<Material> m;
    switch (t) {
    case LAMBERTIAN:
    ...
    case METAL:
        ...
        break;
    case TRANSPARENT:
        m = make_shared<Transparent>(a, d, s,kt, beta, opacity);
        break;
    default:
        break;
    }
